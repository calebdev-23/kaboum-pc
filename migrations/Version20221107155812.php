 ...
 */
final class Version20221107155812 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test_categories (test_id INT NOT NULL, categories_id INT NOT NULL, INDEX IDX_41C0F0511E5D0459 (test_id), INDEX IDX_41C0F051A21214B7 (categories_id), PRIMARY KEY(test_id, categories_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
