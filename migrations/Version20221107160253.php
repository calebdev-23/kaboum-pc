 ...
 */
final class Version20221107160253 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_test (categories_id INT NOT NULL, test_id INT NOT NULL, INDEX IDX_4C268A1E5D0459 (test_id), INDEX IDX_4C268AA21214B7 (categories_id), PRIMARY KEY(categories_id, test_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
